			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Ubicaciones del mapa del sitio - Catuai</title>
					</xsl:when>
					<xsl:otherwise>
						<title>Mapa del sitio XML - Catuai</title>
					</xsl:otherwise>
				</xsl:choose>
				...
				<xsl:choose>
					<xsl:when test="kml:kml">
						...
						<div id="content">
							...
							<p class="expl">
								<a href="http://catuai.local/sitemap_index.xml">&#8592; Índice del mapa del sitio</a>							</p>
